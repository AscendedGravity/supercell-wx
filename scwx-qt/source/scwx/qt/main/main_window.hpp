...
private slots:
   ...
   void on_actionProviderStateInspector_triggered();
   void on_actionWatchDirectory_triggered();
   void on_actionDumpLayerList_triggered();
   void on_actionDumpRadarProductRecords_triggered();
   void on_actionDumpTimelineState_triggered();
   void on_actionDumpCurrentProduct_triggered();
   void on_actionDumpProviderCache_triggered();
   void on_actionLogProviderRequests_triggered(bool checked);
   void on_actionFullScreen_triggered(bool checked);
   void on_actionRadarWireframe_triggered(bool checked);
   void on_actionForceRefresh_triggered();
   void on_actionForceProductReload_triggered();
   void on_actionClearProviderCache_triggered();
   void on_actionLogLevelTrace_triggered();
   void on_actionLogLevelDebug_triggered();
   void on_actionLogLevelInfo_triggered();
   void on_actionLogLevelWarning_triggered();
